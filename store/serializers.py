...
class ProductSerializer(serializers.ModelSerializer):
    class Meta:
        model=Product
        fields=['id','title','description','unit_price','price_with_tax','inventory','collection']
...
class AddCartItemSerializer(serializers.ModelSerializer):
    ...
    def validate_product_id(self, value):
        ERROR_NO_PRODUCT=serializers.ValidationError("There is no product with given ID")
...
class CreateOrderSerializer(serializers.ModelSerializer):
    ...
    def validate_cart_id(self, value):
        ERROR_NO_CART=serializers.ValidationError("No cart with given ID was found")
        ERROR_EMPTY_CART=serializers.ValidationError("This shopping cart is empty")
